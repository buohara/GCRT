...
/**
 * [Mesh::InitModelMatrices description]
 */
...
/**
 * [Mesh::Translate description]
 * @param tx [description]
 */

void Mesh::Translate(vec3 tx)
{
    pos = tx;
    trans = translate(tx);
    model = trans * rot * scl;
...
/**
 * [Mesh::Scale description]
 * @param dimsIn [description]
 */

void Mesh::Scale(vec3 dimsIn)
{
    dims = dimsIn;
