...
/**
* [MainPassVk::CreateDepth description]
*/

void MainPassVk::CreateDepth(VkDevice &logicalDevice)
{
...
/**
* MainPassVk::CreateRenderPass Setup global renderpass for writing to frame buffer.
*/

void MainPassVk::CreateRenderPass(VkDevice &logicalDevice)
{
...
/**
* [MainPassVk::CreatePipelineCache description]
*/

void MainPassVk::CreatePipelineCache(VkDevice &logicalDevice)
{
...
/**
* [MainPassVk::SetupFrameBuffer description]
*/

void MainPassVk::SetupFrameBuffer(VkDevice &logicalDevice)
{
...
/**
* MainPassVk::CreateUniformBuffers Initialize triangle uniforms (just MVP matrices in this case).
*/

void MainPassVk::CreateUniformBuffers(VkDevice &logicalDevice)
{
	VkMemoryRequirements memReqs;
...
/**
* MainPassVk::UpdateUniforms Map and memcopy to uniform buffer.
*/

void MainPassVk::UpdateUniforms(VkDevice &logicalDevice)
{
...
/**
* [MainPassVk::SetupDescriptorPool description]
*/

void MainPassVk::SetupDescriptorPool(VkDevice &logicalDevice)
{
...
/**
* [MainPassVk::SetupDescriptorSetLayout description]
*/

void MainPassVk::SetupDescriptorSetLayout(VkDevice &logicalDevice)
{
...
/**
* [MainPassVk::SetupDescriptorSet description]
*/

void MainPassVk::SetupDescriptorSet(VkDevice &logicalDevice)
{
...
/**
* [MainPassVk::SetupPipelineState description]
*/

void MainPassVk::SetupPipelineState(VkDevice &logicalDevice)
{
...
/**
 * MainPassVk::BuildCommandBuffers
 */

void MainPassVk::BuildCommandBuffers(VkDevice &logicalDevice)
{
...
void MainPassVk::CreateGeometry(VkDevice &logicalDevice)
{
