/* $ANTLR 2.7.7 (2006-11-01): "c2ga_parser.g" -> "c2ga_mv_parser.cpp"$ */
...
c2ga_mv_parser::c2ga_mv_parser(ANTLR_USE_NAMESPACE(antlr)TokenBuffer& tokenBuf, int k)
: ANTLR_USE_NAMESPACE(antlr)LLkParser(tokenBuf,k)
{
}

c2ga_mv_parser::c2ga_mv_parser(ANTLR_USE_NAMESPACE(antlr)TokenBuffer& tokenBuf)
: ANTLR_USE_NAMESPACE(antlr)LLkParser(tokenBuf,2)
{
}

c2ga_mv_parser::c2ga_mv_parser(ANTLR_USE_NAMESPACE(antlr)TokenStream& lexer, int k)
: ANTLR_USE_NAMESPACE(antlr)LLkParser(lexer,k)
{
}

c2ga_mv_parser::c2ga_mv_parser(ANTLR_USE_NAMESPACE(antlr)TokenStream& lexer)
: ANTLR_USE_NAMESPACE(antlr)LLkParser(lexer,2)
{
}

c2ga_mv_parser::c2ga_mv_parser(const ANTLR_USE_NAMESPACE(antlr)ParserSharedInputState& state)
: ANTLR_USE_NAMESPACE(antlr)LLkParser(state,2)
{
}

mv  c2ga_mv_parser::multivector() {
	mv result;
...
std::pair<float, unsigned int>  c2ga_mv_parser::basis_element() {
...
void c2ga_mv_parser::initializeASTFactory( ANTLR_USE_NAMESPACE(antlr)ASTFactory& )
{
}
const char* c2ga_mv_parser::tokenNames[] = {
	"<0>",
	"EOF",
	"<2>",
	"NULL_TREE_LOOKAHEAD",
...
const unsigned long c2ga_mv_parser::_tokenSet_0_data_[] = { 2UL, 0UL, 0UL, 0UL };
// EOF 
const ANTLR_USE_NAMESPACE(antlr)BitSet c2ga_mv_parser::_tokenSet_0(_tokenSet_0_data_,4);
const unsigned long c2ga_mv_parser::_tokenSet_1_data_[] = { 2656UL, 0UL, 0UL, 0UL };
// MINUS PLUS BASIS_VECTOR NUMBER 
const ANTLR_USE_NAMESPACE(antlr)BitSet c2ga_mv_parser::_tokenSet_1(_tokenSet_1_data_,4);
const unsigned long c2ga_mv_parser::_tokenSet_2_data_[] = { 98UL, 0UL, 0UL, 0UL };
// EOF MINUS PLUS 
const ANTLR_USE_NAMESPACE(antlr)BitSet c2ga_mv_parser::_tokenSet_2(_tokenSet_2_data_,4);
